...
namespace service.transport.data
{
    public class TransportRepo : ITransportRepo
    {
        ...
        public async Task<TransportationOption> CreateTransportationOptionAsync(List<TransportationOption> transportationOption)
        {
            transportationOption.ForEach(x => _context.TransportationOptions.Add(x));
            await _context.SaveChangesAsync();
            return transportationOption.FirstOrDefault();
        }
